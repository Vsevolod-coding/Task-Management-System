...
import {
  ...
  NgForm,
  Validators
} from "./chunk-BOBWMMBL.js";
import {
  MAT_FORM_FIELD,
  MatFormFieldControl,
  MatFormFieldModule
} from "./chunk-L2WQOD66.js";
import {
  ErrorStateMatcher,
  MatCommonModule,
  Platform,
  ...
  ngAfterViewInit() {
    if (this._platform.isBrowser) {
      ...
      this._ngZone.runOutsideAngular(() => {
        ...
        this._resizeEvents.pipe((0, import_operators.auditTime)(16)).subscribe(() => this.resizeToFitContent(true));
      });
...
//# sourceMappingURL=chunk-4NVJTFCQ.js.map
